...
open class SVMModel
{
    ...
    open func isνFeasableForData(_ data: DataSet) -> Bool
    {
    ...
    open func train(_ data: DataSet)
    {
    ...
    fileprivate func trainOne(_ data: DataSet, costPositive : Double, costNegative : Double, display : Bool = false) -> DecisionFunction
    {
        var solver : Solver?
    ...
    open func crossValidation(_ data: DataSet, numberOfFolds: Int) -> [Double]
    {
    ...
    open func predictValues(_ data: DataSet)
    {
