 ...
 */
try data.addDataPoint(input: [0.3, 0.9], output:0)
...
if (exampleIndex > 1) {
    try data.addDataPoint(input: [0.3, 0.1], output:0)
}
if (exampleIndex > 3) {
    try data.addDataPoint(input: [0.8, 0.8], output:1)
    try data.addDataPoint(input: [0.9, 0.8], output:1)
    try data.addDataPoint(input: [0.8, 0.9], output:1)
}
