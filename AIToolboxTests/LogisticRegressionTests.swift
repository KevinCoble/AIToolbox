...
class LogisticRegressionTests: XCTestCase {
    ...
    func testBinary() {
        ...
        do {
            try data.addDataPoint(input: [0.50], output:0)
            try data.addDataPoint(input: [0.75], output:0)
            try data.addDataPoint(input: [1.00], output:0)
            try data.addDataPoint(input: [1.25], output:0)
            try data.addDataPoint(input: [1.50], output:0)
            try data.addDataPoint(input: [1.75], output:0)
            try data.addDataPoint(input: [1.75], output:1)
            try data.addDataPoint(input: [2.00], output:0)
            try data.addDataPoint(input: [2.25], output:1)
            try data.addDataPoint(input: [2.50], output:0)
            try data.addDataPoint(input: [2.75], output:1)
            try data.addDataPoint(input: [3.00], output:0)
            try data.addDataPoint(input: [3.25], output:1)
            try data.addDataPoint(input: [3.50], output:0)
            try data.addDataPoint(input: [4.00], output:1)
            try data.addDataPoint(input: [4.25], output:1)
            try data.addDataPoint(input: [4.50], output:1)
            try data.addDataPoint(input: [4.75], output:1)
            try data.addDataPoint(input: [5.00], output:1)
            try data.addDataPoint(input: [5.50], output:1)
        }
        catch {
